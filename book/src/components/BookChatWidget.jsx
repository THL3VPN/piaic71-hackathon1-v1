...
/**
 * BookChatWidget Component
 * A reusable chat widget specifically for the book documentation site
 * This component can be embedded in Docusaurus pages using:
 * import BookChatWidget from '@site/src/components/BookChatWidget';
 */
const BookChatWidget = ({ selectedText = null }) => {
